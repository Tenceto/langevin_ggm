...
from scorematching_gnn.evaluation.mmd import process_tensor, compute_mmd, gaussian, gaussian_emd

PRINT_TIME = True
ORCA_DIR = 'scorematching_gnn/evaluation/orca'  # the relative path to the orca dir
